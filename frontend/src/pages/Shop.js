            ...
            <div className=" w-4/5 mx-auto pt-24 grid md:grid-cols-3 lg:grid-cols-4 gap-2 justify-between">
                <div className="sidebar md:col-span-1 shadow-sm">
                        ...
                        <ul className='block p-4'>
                            {
                                category ? category.map(cat => {
                                    return (
                                        <li className='my-2 p-3 text-gray-500 hover:text-pink-500 hover:font-semibold cursor-pointer flex items-center' key={cat._id}>
                    ...
                    <div className="brand my-4 border-l-2">
                        ...
                        <h3 className='font-bold py-3 uppercase border-b-2 flex justify-between items-center flex-wrap'>Brands <span><FaFireAlt /></span></h3>
                        <ul className='block p-4'>
                            {
                                brands ? brands.map(brand => {
                                    return (
                                        <li className='my-2 p-3 text-gray-500 hover:text-pink-500 hover:font-semibold cursor-pointer flex items-center' key={brand._id}>
